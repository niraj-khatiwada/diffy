					...
					{value ? (
						<div className="flex flex-col items-center">
							...
							<div className="text-sm">
								<p className={`font-medium ${value ? "text-primary" : ""}`}>
									{value.name}
								</p>
								<p className="text-gray-500">Click or drop file to replace</p>
							</div>
						</div>
					) : (
						<p className="text-xs text-gray-400">Drop or select a file</p>
					)}
				</button>
